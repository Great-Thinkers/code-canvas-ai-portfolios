              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed max-w-lg">
                    {personal.bio ||
                      "I create meaningful digital experiences through thoughtful design and development. My work focuses on simplicity, functionality, and human-centered solutions."}
                  </p>
                  {personal.location && (
                    ...
                    <div className={index % 2 === 0 ? "order-2" : "order-1"}>
                      ...
                      <div className="flex gap-6">
                        {project.github && (
                          <a
                            href={project.github}
                            className="text-sm uppercase tracking-wider border-b border-gray-900 hover:border-gray-400 transition-colors"
                          >
                            View Code
                          </a>
                        )}
              ...
              <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-16">
                {social.email && (
                  <a
                    ...
                    className="text-lg border-b border-gray-900 hover:border-gray-400 transition-colors"
                  >
                    {social.email}
                  </a>
                )}
