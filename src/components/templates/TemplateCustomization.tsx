...
export default function TemplateCustomization({ template, onNext, onBack }: TemplateCustomizationProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-display font-bold">Customize Your Portfolio</h2>
          <p className="text-muted-foreground">Preview how the {template.name} template will look with your information</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <Card className="overflow-hidden">
            <div className="aspect-video bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-800 dark:to-slate-900 p-6 relative">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 h-full overflow-hidden">
                ...
                <p className="text-sm text-muted-foreground mb-4 line-clamp-2">{userData.bio}</p>
          ...
          <div className="text-center text-sm text-muted-foreground">
            This is a simplified preview. The actual template will include your full portfolio with projects, experience, and more detailed sections.
          </div>
        </div>
      </div>
